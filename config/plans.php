...
return [
    ...
    */
    'pro' => [
        ...
        'price_annual' => env('PLAN_PRO_PRICE_ANNUAL', 182), // $182/yr ≈ 20% off ($19 × 12 = $228, exact 20% = $182.40, rounded to nearest dollar)
    ...
    */
    'team' => [
        ...
        // These MUST be kept in sync whenever pricing changes — update the Stripe price object first, then this default.
        'price_annual' => env('PLAN_TEAM_PRICE_ANNUAL', 470), // $470/seat/yr ≈ 20% off ($49 × 12 = $588, exact 20% = $470.40, rounded to nearest dollar)
        'per_seat' => true,

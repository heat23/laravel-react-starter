...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ...
    {...props}
  >
    <CheckboxPrimitive.Indicator className={cn("flex items-center justify-center text-current transition-transform duration-100 data-[state=checked]:animate-in data-[state=checked]:zoom-in-75")}>

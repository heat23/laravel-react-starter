...
export default function Edit({
  ...
  const handleTimezoneChange = async (newTimezone: string) => {
    ...
    if (success) {
      ...
      toast.error(
        'Failed to update timezone. Please check your connection and try again.'
      );
    }
  };
            ...
            <CardContent>
              <div className="max-w-xl">
                <p className="text-sm text-muted-foreground mb-4">
                  Export all your personal data including profile, settings,
                  activity logs, and connected accounts in JSON format.
                </p>
                <Button variant="outline" asChild>
                  <a href={route('export.personal-data')} download>

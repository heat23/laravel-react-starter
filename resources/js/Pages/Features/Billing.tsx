...
const faqs = [
  {
    ...
    answer:
      'Yes — BillingService passes through any Stripe subscription options. Add tax_rates to the subscription options in config/plans.php.',
  },
  {
    question: 'Can I add metered billing?',
    answer:
      'Yes — Stripe\u2019s metered billing is a subscription item type. Add a metered price ID to the plan config and update updateQuantity() in BillingService.',
  },
  {
    question: 'What happens if Redis is down?',
    answer:
      'The BillingService catches lock acquisition failures and throws ConcurrentOperationException, which returns a user-facing error. Billing never silently double-processes.',
  },
];
          ...
          <article className="mx-auto max-w-4xl">
            <header className="py-16 text-center">
              ...
              <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
                Two concurrent subscribe requests. A declined payment at 2am. A
                team downgrade mid-cycle. This starter handles all of it.
              </p>
            </header>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="rounded-2xl border border-border/70 bg-muted/40 p-6">
                  <p className="font-semibold text-foreground">
                    Solo founder launching a SaaS
                  </p>
                  <p className="mt-2 text-sm text-muted-foreground">
                    Charge customers on day one without building a billing
                    system from scratch — Redis locks, dunning emails, and plan
                    tiers are already wired up.
                  </p>
                </div>
                <div className="rounded-2xl border border-border/70 bg-muted/40 p-6">
                  <p className="font-semibold text-foreground">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    Hand off a production-ready billing setup without teaching
                    your client Stripe — the billing portal, incomplete payment
                    recovery, and admin dashboard are all included.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="prose prose-neutral dark:prose-invert mb-16 max-w-none">
              ...
              <p>
                Billing mutations are tested with Stripe mock responses, so the
                test suite runs without a live Stripe account. Concurrent
                ...
                clear error message. Admin billing stats are tested with seeded
                subscription data and cache invalidation assertions that verify
            ...
            <section className="prose prose-neutral dark:prose-invert mb-16 max-w-none">
              ...
              <p>
                ...
                lives in <code>app/Services/BillingService.php</code>,{' '}
                <code>app/Http/Controllers/Billing/</code>, and{' '}
                <code>resources/js/Pages/Billing/</code>. You can read it, audit
                it, and extend it. There is no black box — no SDK that hides the
                Stripe API calls behind an abstraction you can&apos;t inspect.
                When Stripe changes their API or you need custom proration
                logic, you change one file, not fight a framework. The billing
                service is approximately 200 lines of PHP. It uses Redis locks,
                database transactions, and Laravel Cashier. That&apos;s it.
              </p>
            </section>
            ...
            <section className="prose prose-neutral dark:prose-invert mb-16 max-w-none">
              ...
              <p>
                Stripe communicates subscription events (payment failed,
                subscription updated, invoice finalized) via webhooks. The
                billing system relies on incoming Stripe webhooks for dunning
                and incomplete payment recovery. If you&apos;re building
                outgoing webhooks to notify your own customers of subscription
                changes, see the{' '}
                <Link
                ...
                for HMAC signing, queue-based retry, and delivery tracking
                patterns.
              </p>
            </section>
              ...
              items={[
                {
                  ...
                  description:
                    'Subscriptions, webhooks, and race condition prevention',
                },
                {
                ...
                },
                {
                  ...
                  description:
                    'Toggle billing and other features with one env var',
                },
              ]}
            />
          </article>

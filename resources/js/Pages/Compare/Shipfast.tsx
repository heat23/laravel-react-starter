        ...
        <main className="container pb-24">
          <article className="mx-auto max-w-4xl">
            ...
            <section className="mt-16 rounded-2xl border border-border bg-card p-8 text-center shadow-sm">
              <h2 className="text-2xl font-bold">Shipfast is ~$299. This starter is a one-time fee.</h2>
              <p className="mt-2 text-muted-foreground">
                Laravel + React + TypeScript &mdash; the PHP equivalent of Shipfast, with an admin panel and 90+ tests.
              </p>
